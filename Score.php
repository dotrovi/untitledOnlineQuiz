...
<?php
	...
	<label class="w3-text-blue"><h3><b>SENARAI SKOR</b></h3></label>
	...
	<table class="b w3-table w3-centered w3-animate-opacity" border="1" style="width:70%; margin: auto;">
		...
		<tr>
			...
			if (mysqli_num_rows($sql) == 0) {
				echo '<tr class="w3-pale-green"><td colspan="6">Tiada data skor!</td></tr>';
			} else {
				while ($row = mysqli_fetch_array($sql)) {
					...
					echo '<tr class="w3-pale-green">
						...
						<td><a href="delete.php?q=3&id='.$idskor.'"><button class="w3-button w3-red"> PADAM </button></a></td>
						<tr>';
				}
			}
?>
